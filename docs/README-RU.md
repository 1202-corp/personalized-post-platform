...
- `GET /health/ready` - Проверка Telethon и api
...
# Генерация миграции
docker exec ppb-api alembic revision --autogenerate -m "description"

# Применить миграции
docker exec ppb-api alembic upgrade head

# Откатить миграцию
docker exec ppb-api alembic downgrade -1
```
